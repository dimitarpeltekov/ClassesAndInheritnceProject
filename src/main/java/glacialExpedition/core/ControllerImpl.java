      ...
      result.append(ConstantMessages.FINAL_EXPLORER_INFO);
        ...
        for(Explorer explorer : explorers){
            ...
            if(explorer.getSuitcase().getExhibits().isEmpty()){
                ...
                result.append(String.format(ConstantMessages.FINAL_EXPLORER_SUITCASE_EXHIBITS,String.join(ConstantMessages.FINAL_EXPLORER_SUITCASE_EXHIBITS_DELIMITER,explorer.getSuitcase().getExhibits())));
            }
        }
